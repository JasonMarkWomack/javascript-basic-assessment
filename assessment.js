...
var firstHero = heroes.slice(0)[0];
...
var secondHero = heroes.slice(2)[0];
...
//function doubleTheFun (paramyy) {
//	if (Number(paramyy)) {
	//	parameter = (Number(paramy) * 2);
	//} else if (typeof paramyy === 'string' || paramyy instanceof String) {
